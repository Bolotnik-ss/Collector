<?php 
$page_title = 'Редактирование открытки';
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title mb-4">Редактирование открытки</h2>
                    <form action="/postcard_collection/<?= $collection_id ?>/postcard/<?= $postcard['id'] ?>/update" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="collection_id" value="<?= $collection_id ?>">
                        <!-- Название, Страна, Год -->
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label for="name" class="form-label">Название открытки</label>
                                <input type="text" class="form-control" id="name" name="name" value="<?= htmlspecialchars($postcard['name']) ?>" required>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="country_id" name="country_id" required>
                                        ...
                                        <?php foreach ($countries as $country): ?>
                                            <option value="<?= $country['id'] ?>" <?= $country['id'] == $postcard['country_id'] ? 'selected' : '' ?>>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="year" name="year" value="<?= htmlspecialchars($postcard['year']) ?>" required min="1860" max="<?= date('Y') ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="code" name="code" value="<?= htmlspecialchars($postcard['code']) ?>">
                            </div>
                            <div class="col-md-3">
                                <label for="mintage" class="form-label">Тираж</label>
                                <input type="number" class="form-control" id="mintage" name="mintage" value="<?= htmlspecialchars($postcard['mintage']) ?>" min="1">
                        </div>
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="material_id" name="material_id" required>
                                        ...
                                        <?php foreach ($materials as $material): ?>
                                            <option value="<?= $material['id'] ?>" <?= $material['id'] == $postcard['material_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="type_id" name="type_id" required>
                                        ...
                                        <?php foreach ($types as $type): ?>
                                            <option value="<?= $type['id'] ?>" <?= $type['id'] == $postcard['type_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="series_id" name="series_id" required>
                                        ...
                                        <?php foreach ($series as $s): ?>
                                            <option value="<?= $s['id'] ?>" <?= $s['id'] == $postcard['series_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="rarity_id" name="rarity_id" required>
                                        ...
                                        <?php foreach ($rarities as $rarity): ?>
                                            <option value="<?= $rarity['id'] ?>" <?= $rarity['id'] == $postcard['rarity_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="theme_id" name="theme_id" required>
                                        ...
                                        <?php foreach ($themes as $theme): ?>
                                            <option value="<?= $theme['id'] ?>" <?= $theme['id'] == $postcard['theme_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="publisher_id" name="publisher_id" required>
                                        ...
                                        <?php foreach ($publishers as $publisher): ?>
                                            <option value="<?= $publisher['id'] ?>" <?= $publisher['id'] == $postcard['publisher_id'] ? 'selected' : '' ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3"><?= htmlspecialchars($postcard['description']) ?></textarea>
                        </div>
                        <!-- Изображения -->
                        <div class="row mb-3">
                            <?php if ($postcard['avers_image']): ?>
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-2">
                                        <img src="<?= htmlspecialchars($postcard['avers_image']) ?>" alt="Аверс" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                            ...
                            <?php if ($postcard['revers_image']): ?>
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-2">
                                        <img src="<?= htmlspecialchars($postcard['revers_image']) ?>" alt="Реверс" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                                    <div class="form-check mb-2">
