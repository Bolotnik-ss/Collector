<?php
$page_title = 'Добавление банкноты в коллекцию';
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title mb-4">Добавление банкноты</h2>
                    
                    <form action="/banknote_collection/<?= $collection['id'] ?>/banknote/store" method="POST" enctype="multipart/form-data">
                        <!-- Название, Страна, Год -->
                        <div class="row mb-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="year" name="year" required min="800" max="<?= date('Y') ?>">
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="/banknote_collection/<?= $collection['id'] ?>" class="btn btn-secondary">
                                <i class="bi bi-arrow-left"></i> Назад
                            </a>
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-lg"></i> Добавить банкноту
                            </button>
                        </div>
                    </form>
                </div>
