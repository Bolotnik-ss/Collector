<?php
$page_title = 'Редактирование банкноты';
include __DIR__ . '/../layout/header.php';
?>

<?php
$banknoteDictionaryService = new BanknoteDictionaryService();
$countries = $banknoteDictionaryService->getCountries();
$types = $banknoteDictionaryService->getTypes();
$units = $banknoteDictionaryService->getUnits();
$series = $banknoteDictionaryService->getSeries();
$rarities = $banknoteDictionaryService->getRarities();
$materials = $banknoteDictionaryService->getMaterials();
?>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title mb-4">Редактирование банкноты</h2>

                    <form action="/banknote_collection/<?= $collection_id ?>/banknote/<?= $banknote['id'] ?>/update" method="POST" enctype="multipart/form-data">
                        <input type="hidden" name="collection_id" value="<?= $collection_id ?>">
                        
                        <!-- Название, Страна, Год -->
                        <div class="row mb-3">
                            <div class="col-md-4">
                            <label for="name" class="form-label">Название банкноты</label>
                                <input type="text" class="form-control" id="name" name="name" value="<?= htmlspecialchars($banknote['name']) ?>" required>
                        </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="country_id" name="country_id" required>
                                        ...
                                        <?php foreach ($countries as $country): ?>
                                            <option value="<?= $country['id'] ?>" <?= $country['id'] == $banknote['country_id'] ? 'selected' : '' ?>>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" class="form-control" id="year" name="year" value="<?= intval($banknote['year']) ?>" required min="800" max="<?= date('Y') ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="code" name="code" value="<?= htmlspecialchars($banknote['code']) ?>">
                            </div>
                            <div class="col-md-3">
                                <label for="denomination" class="form-label">Номинал</label>
                                <input type="number" class="form-control" id="denomination" name="denomination" value="<?= htmlspecialchars($banknote['denomination']) ?>" required step="any" min="0.01">
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="unit_id" name="unit_id" required>
                                        ...
                                        <?php foreach ($units as $unit): ?>
                                            <option value="<?= $unit['id'] ?>" <?= $unit['id'] == $banknote['unit_id'] ? 'selected' : '' ?>>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control" id="mintage" name="mintage" value="<?= htmlspecialchars($banknote['mintage']) ?>" required min="1">
                                </div>
                            </div>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="material_id" name="material_id" required>
                                        ...
                                        <?php foreach ($materials as $material): ?>
                                            <option value="<?= $material['id'] ?>" <?= $material['id'] == $banknote['material_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="type_id" name="type_id" required>
                                        ...
                                        <?php foreach ($types as $type): ?>
                                            <option value="<?= $type['id'] ?>" <?= $type['id'] == $banknote['type_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="series_id" name="series_id" required>
                                        ...
                                        <?php foreach ($series as $s): ?>
                                            <option value="<?= $s['id'] ?>" <?= $s['id'] == $banknote['series_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="rarity_id" name="rarity_id" required>
                                        ...
                                        <?php foreach ($rarities as $rarity): ?>
                                            <option value="<?= $rarity['id'] ?>" <?= $rarity['id'] == $banknote['rarity_id'] ? 'selected' : '' ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3"><?= htmlspecialchars($banknote['description']) ?></textarea>
                        </div>
                        ...
                        <div class="row mb-3">
                            <?php if ($banknote['avers_image']): ?>
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-2">
                                        <img src="<?= htmlspecialchars($banknote['avers_image']) ?>" alt="Аверс" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                            ...
                            <?php if ($banknote['revers_image']): ?>
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-2">
                                        <img src="<?= htmlspecialchars($banknote['revers_image']) ?>" alt="Реверс" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                                    <div class="form-check mb-2">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="/banknote_collection/<?= $collection_id ?>" class="btn btn-secondary">
...
<?php
$modals = [
    'Country' => ['title' => 'Добавить новую страну', 'label' => 'Название страны', 'endpoint' => '/api/banknotes/dictionary/countries'],
    'Type' => ['title' => 'Добавить новый тип', 'label' => 'Название типа', 'endpoint' => '/api/banknotes/dictionary/types'],
    'Unit' => ['title' => 'Добавить новую валюту', 'label' => 'Название валюты', 'endpoint' => '/api/banknotes/dictionary/units'],
    'Series' => ['title' => 'Добавить новую серию', 'label' => 'Название серии', 'endpoint' => '/api/banknotes/dictionary/series'],
    'Rarity' => ['title' => 'Добавить новую редкость', 'label' => 'Название редкости', 'endpoint' => '/api/banknotes/dictionary/rarities'],
    'Material' => ['title' => 'Добавить новый материал', 'label' => 'Название материала', 'endpoint' => '/api/banknotes/dictionary/materials']
];
