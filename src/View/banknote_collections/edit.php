<?php
$page_title = 'Редактирование коллекции банкнот';
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title mb-4">Редактирование коллекции банкнот</h2>

                    <form action="/banknote_collection/edit/<?= $collection['id'] ?>" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="/banknote_collections" class="btn btn-secondary">
