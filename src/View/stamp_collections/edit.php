<?php 
$page_title = 'Редактирование коллекции марок';
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title mb-4">Редактирование коллекции марок</h2>

                    <form action="/stamp_collection/edit/<?= $collection['id'] ?>" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="/stamp_collections" class="btn btn-secondary">
