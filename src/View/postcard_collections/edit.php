<?php 
$page_title = 'Редактирование коллекции открыток';
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title mb-4">Редактирование коллекции открыток</h2>

                    <form action="/postcard_collection/edit/<?= $collection['id'] ?>" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="/postcard_collections" class="btn btn-secondary">
