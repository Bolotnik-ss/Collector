<?php 
$page_title = 'Добавление марки в коллекцию';
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title mb-4">Добавление марки</h2>
                    <form action="/stamp_collection/<?= $collection_id ?>/stamp/store" method="POST" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control" id="year" name="year" required min="1840" max="<?= date('Y') ?>">
                            </div>
                            <div class="col-md-3">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="bi bi-check-lg"></i> Добавить марку
                            </button>
                        </div>
                    </form>
                </div>
