...
<head>
    ...
    <title><?php echo $isSuccess ? 'Email успешно изменен' : 'Ошибка смены email'; ?></title>
                ...
                <div class="card shadow-sm">
                    <div class="card-body p-4 text-center">
                        <?php if ($isSuccess): ?>
                            ...
                            <h2 class="card-title mt-3 mb-4">Email успешно изменен!</h2>
                            
                            <div class="alert alert-success">
                                <h4 class="alert-heading mb-3">Отлично!</h4>
                                <p class="mb-0">Ваш email адрес был успешно изменен.</p>
                            </div>

                            <div class="d-grid gap-2 mt-4">
                                <a href="/profile" class="btn btn-primary">
                                    <i class="bi bi-person"></i> Вернуться в профиль
                                </a>
                            </div>
                        <?php else: ?>
                            ...
                            <div class="alert alert-warning">
                                ...
                                <p class="mb-0 text-start">Не удалось изменить email. Возможно:</p>
                            ...
                            <div class="mt-4">
                                <p class="text-muted">
                                    <small>
                                        Если вы недавно запрашивали смену email, попробуйте запросить новую ссылку.<br>
