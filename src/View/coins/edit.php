<?php 
$page_title = 'Редактирование монеты';
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-body">
                    <h2 class="card-title mb-4">Редактирование монеты</h2>
                    
                    <form action="/coin_collection/<?= $collection_id ?>/coin/<?= $coin['id'] ?>/update" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="name" name="name" value="<?= htmlspecialchars($coin['name']) ?>" required>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="country_id" name="country_id" required>
                                        ...
                                        <?php foreach ($countries as $country): ?>
                                            <option value="<?= $country['id'] ?>" <?= $country['id'] == $coin['country_id'] ? 'selected' : '' ?>>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="year" name="year" value="<?= abs(intval($coin['year'])) ?>" required min="0" max="<?= date('Y') ?>">
                                    <div class="input-group-text">
                                        <div class="form-check mb-0">
                                            <input class="form-check-input" type="checkbox" id="is_bc" name="is_bc" <?= intval($coin['year']) < 0 ? 'checked' : '' ?>>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="code" name="code" value="<?= htmlspecialchars($coin['code']) ?>">
                            </div>
                            <div class="col-md-3">
                                <label for="denomination" class="form-label">Номинал</label>
                                <input type="number" class="form-control" id="denomination" name="denomination" value="<?= htmlspecialchars($coin['denomination']) ?>" required step="any" min="0.01">
                            </div>
                            <div class="col-md-3">
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="unit_id" name="unit_id" required>
                                        ...
                                        <?php foreach ($units as $unit): ?>
                                            <option value="<?= $unit['id'] ?>" <?= $unit['id'] == $coin['unit_id'] ? 'selected' : '' ?>>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control" id="mintage" name="mintage" value="<?= htmlspecialchars($coin['mintage']) ?>" required min="1">
                            </div>
                        </div>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="material_id" name="material_id" required>
                                        ...
                                        <?php foreach ($materials as $material): ?>
                                            <option value="<?= $material['id'] ?>" <?= $material['id'] == $coin['material_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="type_id" name="type_id" required>
                                        ...
                                        <?php foreach ($types as $type): ?>
                                            <option value="<?= $type['id'] ?>" <?= $type['id'] == $coin['type_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="series_id" name="series_id" required>
                                        ...
                                        <?php foreach ($series as $s): ?>
                                            <option value="<?= $s['id'] ?>" <?= $s['id'] == $coin['series_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="input-group">
                                    <select class="form-select" id="rarity_id" name="rarity_id" required>
                                        ...
                                        <?php foreach ($rarities as $rarity): ?>
                                            <option value="<?= $rarity['id'] ?>" <?= $rarity['id'] == $coin['rarity_id'] ? 'selected' : '' ?>>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3"><?= htmlspecialchars($coin['description']) ?></textarea>
                        </div>
                        ...
                        <div class="row mb-3">
                            <?php if ($coin['avers_image']): ?>
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-2">
                                        <img src="<?= htmlspecialchars($coin['avers_image']) ?>" alt="Аверс" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                            ...
                            <?php if ($coin['revers_image']): ?>
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-2">
                                        <img src="<?= htmlspecialchars($coin['revers_image']) ?>" alt="Реверс" class="img-thumbnail" style="max-width: 200px;">
                                    </div>
                                    <div class="form-check mb-2">
