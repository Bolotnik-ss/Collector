...
class PostcardCollectionService {
    // Создание новой коллекции
    public function createCollection($user_id, $name, $description) {
        return PostcardCollection::create($user_id, $name, $description);
    }

    // Получение коллекций пользователя
    public function getCollections($user_id) {
        return PostcardCollection::findAllByUser($user_id);
    }

    // Получение коллекции по ID
    public function getCollectionById($id) {
        return PostcardCollection::findById($id);
    }

    // Обновление коллекции
    public function updateCollection($id, $name, $description) {
        PostcardCollection::update($id, $name, $description);
    }

    // Удаление коллекции
    public function deleteCollection($id) {
        PostcardCollection::delete($id);
    }
